...
<template>
  ...
  <icon name="align-justify" size="30px" class="text-white" style="margin-right: 8px" />
    ...
    <div :class="['side-bar', { active: isSidebarOpen }]">
  <header>
    <div class="close-btn" @click="toggleSidebar">
      <icon name="xmark" size="30px" class="text-white" style="margin-right: 8px" />
    </div>
      ...
      <div class="menu">
  <div class="item">
    <a class="sub-btn" @click="toggleSubMenu('tables')">
      <icon name="display" size="20px" class="text-white fas fa-table" style="margin-right: 8px" />
      Tables
      <icon :class="{ rotate: activeSubMenu === 'tables' }" name="angle-right" size="30px" class="text-white fas fa-angle-right dropdown" style="margin-right: 8px" />
    </a>
    <div class="sub-menu" :style="{ display: activeSubMenu === 'tables' ? 'block' : 'none' }">
  ...
  <div class="item">
    <a class="sub-btn" @click="toggleSubMenu('settings')">
      <i class="fas fa-cogs"></i>Settings
      <i :class="{ rotate: activeSubMenu === 'settings' }" class="fas fa-angle-right dropdown"></i>
    </a>
    <div class="sub-menu" :style="{ display: activeSubMenu === 'settings' ? 'block' : 'none' }">
      <a href="#" class="sub-item">Sub Item 01</a>
      <a href="#" class="sub-item">Sub Item 02</a>
    </div>
  </div>
...
const staffInfo = ref(globalStore.staffInfo);
...
onMounted(() => {
  eventBus.on('staffInfo', (newStaffInfo) => {
    staffInfo.value = newStaffInfo;
  });
});

onBeforeUnmount(() => {
  eventBus.off('staffInfo');
});
</script>
