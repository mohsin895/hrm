            ...
            <ul class="main-menu">
              ...
              >
                ...
                <ul class="sub-menu">
                  ...
                  >
                    <router-link :to="{name:'EmployeeLeaveList'}">My Leaves</router-link>
                  </li>
                </ul>
              </li>
              <li
              ...
              >
                ...
                <ul class="sub-menu">
                  <li
                    ...
                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-78"
                  >
                  <router-link :to="{name:'EmployeeSalary'}"> Salary Slips</router-link>
                  </li>
                  <li
                    id="menu-item-78"
                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-78"
                  >
                    <router-link :to="{name:'EmployeeExpense'}">Expense Claims</router-link>
                  </li>
                </ul>
              </li> <li
                id="menu-item-6"
                class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-4 current_page_item menu-item-6"
              >
               <router-link :to="{name:'EmployeeAttendence'}">Attendance</router-link>
              </li>
